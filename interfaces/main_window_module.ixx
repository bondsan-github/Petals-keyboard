...
export import std.core; // import and export the required interfaces
...
//{
   ...
   export class main_window : public window , public d2d// abstract
   {
      protected:
         ...
         PAINTSTRUCT             paint{};
         D2D1::ColorF                  colour_clear{ 0.2f , 0.2f , 0.2f , 0.0f };

         IDWriteTextFormat *     text_format{}; // simple version of text_layout
         IDWriteTextLayout *     text_layout{};
         std::wstring                 text_name{ L"Times New Roman" };
         uint                    text_size{ 15 }; // 10.0f * 96.0f/72.0f, 
         DWRITE_TEXT_METRICS *   text_metrics{};
         D2D1::ColorF                  text_colour{ D2D1::ColorF::LightYellow };
